...
function [r1,r2]=Q8(Vtrip,shift_range,sigma,over_samp,RF_ontime,target_falsewkup,target_misswkup,target_pfp,err_tol,err_tol_fn,err_tol_fp,code_length_min,code_length_max)
