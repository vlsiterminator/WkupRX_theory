...
function [r1,r2]=Q9(Vtrip,shift_range,sigma,over_samp,RF_ontime,target_falsewkup,target_misswkup,target_Vtrip_i,err_tol,err_tol_fn,err_tol_fp,code_length_min,code_length_max)
    ...
    for code_length = code_length_min:code_length_max
        ...
        for ones_count = (2+err_tol):(code_length-err_tol-1) 
            ...
            if(Calc_Falsewkup(code_length,ones_count,code_bandwidth_dig,code_pfp(target_Vtrip_i),err_tol_mode,err_tol,err_tol_fp,err_tol_fn) < target_falsewkup ...
                ...
                Vtrip_shift_min(ones_count,code_length) = Vtrip(target_Vtrip_i);
            end
